...
export const translations = {
  nl: {
    ...
    aboutStory1: 'Ik ben **Tom Creemers** en ik heb één passie: **gastvrijheid die raakt**. Niet de standaard service, maar die momenten waarop gasten voelen dat alles precies klopt. Dankzij mijn talenkennis en internationale ervaring weet ik gasten van overal ter wereld een gevoel van thuiskomen te geven. Een klein gebaar, een grapje in hun taal of een oprechte interesse in hun achtergrond - dat zijn de momenten waarop service verandert in beleving.',
    ...
    aboutNetwork: 'Ik werk met een **klein, betrouwbaar netwerk** van professionals. Mensen die net als ik geloven in **uitstekende kwaliteit, zonder de kwantiteit uit het oog te verliezen**. Samen zorgen we ervoor dat elk project **vlekkeloos verloopt**.',
  ...
  en: {
    ...
    aboutStory1: 'I am **Tom Creemers** and I have one passion: **hospitality that touches**. Not standard service, but those moments when guests feel that everything is just right. Thanks to my language skills and international experience, I know how to give guests from all over the world a feeling of coming home. A small gesture, a joke in their language, or genuine interest in their background - these are the moments when service transforms into experience.',
    ...
    aboutNetwork: 'I work with a **small, reliable network** of professionals. People who, like me, believe in **excellent quality, without losing sight of quantity**. Together we ensure that every project **runs flawlessly**.',
  ...
  de: {
    ...
    aboutStory1: 'Ich bin **Tom Creemers** und ich habe eine Leidenschaft: **Gastfreundschaft, die berührt**. Nicht Standard-Service, sondern diese Momente, in denen Gäste spüren, dass alles stimmt. Dank meiner Sprachkenntnisse und internationalen Erfahrung weiß ich, wie ich Gästen aus aller Welt ein Gefühl des Nachhausekommens vermitteln kann. Eine kleine Geste, ein Witz in ihrer Sprache oder echtes Interesse an ihrem Hintergrund - das sind die Momente, in denen Service zur Erfahrung wird.',
    ...
    aboutNetwork: 'Ich arbeite mit einem **kleinen, zuverlässigen Netzwerk** von Fachkräften. Menschen, die wie ich an **ausgezeichnete Qualität glauben, ohne die Quantität aus den Augen zu verlieren**. Zusammen sorgen wir dafür, dass jedes Projekt **fehlerfrei läuft**.',
