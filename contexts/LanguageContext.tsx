...
export const translations = {
  nl: {
    ...
    aboutStory2: '**Bijna de helft van mijn leven** verzorg ik verschillende horeca diensten. Van sommelier in kleine restaurants tot welkomstcomité op grote evenementen. Ik heb geleerd dat het draait om **anticiperen op hetgeen gasten nodig hebben**, voordat ze het zelf weten.',
  ...
  en: {
    ...
    aboutStory2: '**Nearly half my life** I have provided various hospitality services. From sommelier in small restaurants to welcome committee at large events. I have learned that it\'s about **anticipating what guests need**, before they know it themselves.',
  ...
  de: {
    ...
    aboutStory2: '**Fast die Hälfte meines Lebens** biete ich verschiedene Gastronomiedienstleistungen an. Vom Sommelier in kleinen Restaurants bis zum Begrüßungskomitee bei großen Events. Ich habe gelernt, dass es darum geht, **zu antizipieren, was Gäste brauchen**, bevor sie es selbst wissen.',
